...
import { CCTPDashboardWidget } from '@/components/CCTPDashboardWidget';
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 flex items-center">
            ...
            <Zap className="h-5 w-5 sm:h-6 sm:w-6 ml-2 text-yellow-500" title="Real-time updates enabled" />
          </h1>
        ...
        <div className="flex gap-2 sm:gap-3 w-full sm:w-auto">
          ...
          <Button
            onClick={() => window.scrollTo({ top: document.getElementById('qr-generator')?.offsetTop || 0, behavior: 'smooth' })}
            className="flex-1 sm:flex-none"
            size="sm"
          >
