...
export class BalanceService {
    constructor(provider) {
        ...
        Object.defineProperty(this, "solanaConnection", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "priceService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async getEthereumBalance(address) {
        try {
            const ethProvider = new BrowserProvider(this.provider);
    ...
    async getUSDCBalance(address) {
        try {
            ...
            const associatedTokenAddress = await getAssociatedTokenAddress(USDC_MINT, ownerPublicKey);
